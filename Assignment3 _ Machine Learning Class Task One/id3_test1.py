...
#Get data (change the path to where your data is based)
train_data_m = pd.read_csv(r"C:\Users\hp\Documents\AI\assignments\task3\data\data.csv") #importing the dataset from the disk
train_data_t = pd.read_csv(r"C:\Users\hp\Documents\AI\assignments\task3\data\data.csv") #importing the dataset from the disk
...
test_data_m = train_data_t #importing test dataset into dataframe

accuracy = evaluate(tree, test_data_m, 'Fast') #evaluating the test dataset
